...
const initial = [
  "성심당 직원은 친절, 친절, 친절한 안내가 인상적이었어요. 빵은 맛있다.",
  "성심당 직원은 친절, 친절해서 기분이 좋았어요. 빵은 맛있다.",
  "성심당 빵 가격은 저렴, 정말 저렴. 빵은 맛있다.",
  "성심당 가격이 저렴, 정말 저렴해서 여러 개 샀어요. 포장도 깔끔했어요.",
  "성심당 명란바게트는 맛있다. 포장이 깔끔하고 특별한 메뉴가 인상적이었어요.",
];
